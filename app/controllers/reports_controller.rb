class ReportsController < DashboardController
  ...
  def index
    @unassigned_reports = Report.unassigned.by_newest.page(params[:unassigned_page]).per(10)
    @pending_reports = Report.pending.by_newest.page(params[:pending_page]).per(10)
  end
