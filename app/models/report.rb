class Report < ActiveRecord::Base
  ...
  # CONSTANTS #
  AGEGROUP    = ['Youth (0-17)', 'Young Adult (18-34)', 'Adult (35-64)', 'Senior (65+)']
  SETTING     = ['Public Space', 'Workplace', 'School', 'Home', 'Other']
  OBSERVATION = ['At-risk of harm', 'Under the influence', 'Anxious', 'Depressed', 'Aggarvated', 'Threatening']
  GENDER      = %w(Male Female Other)
  ETHNICITY   = ['Hispanic or Latino', 'American Indian or Alaska Native', 'Asian', 'Black or African American', 'Native Hawaiian or Pacific Islander', 'White', 'Other/Unknown']
